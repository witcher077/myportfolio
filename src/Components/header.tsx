...
const Header = () => {
    ...
    return (
        <div className='flex justify-between items-center  bg-gray-700 py-7 px-4 z-50 sticky w-full top-0 left-0 '>
            <div>
                <h1 className='flex items-center justify-center text-2xl font-bold text-green-800'><FaLessThan /><span className=' text-white'>Ashok Mahto</span><RxSlash /><FaGreaterThan /></h1>
            </div>
