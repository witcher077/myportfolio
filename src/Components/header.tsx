...
const Header = () => {
    ...
    return (
        <div className='header flex justify-between items-center   py-7 lg:px-4 px-3 z-50 sticky w-full top-0 left-0 '>
            <div>
            ...
            <div className={`lg:bg-transparent bg-blue-300  rounded-bl-md px-7 ${isOpen ? "absolute top-0 right-0 block" : "hidden"} lg:block  sm:min-w-60`}>
                <ul onClick={closeNav} className='flex gap-7 lg:flex-row flex-col  my-5 lg:m-0'>
